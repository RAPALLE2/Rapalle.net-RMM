...
const ICONS = {
  ...
  "🔌": svg(`<path d="M5 2v3h2V2h1.4v3h2V2H12v4a3 3 0 0 1-3 3v2.4a1.6 1.6 0 0 1-3.2 0V9H5a3 3 0 0 1-3-3V5h3z" fill="${C.amber}" transform="translate(1.4 .6) rotate(20 8 8)"/>`),
